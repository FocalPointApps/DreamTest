  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: () async {
        try{
          bool review=true;
        if(review&&notificationList[index].notificationType=="Review_Notification")
         {
           review=false;
           //StoreRedirect.redirect(androidAppId: 'com.app.dreamTest',iOSAppId: '1515745954');
           ...
           Navigator.push(
             ...
             MaterialPageRoute(
               builder: (context) =>
                   AddReviewScreen(consultId: notificationList[index].consultUid!,userId:notificationList[index].userUid!,
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Text(
                  ...
                  style: TextStyle( fontFamily: getTranslated(context, 'fontFamily'), fontSize: 14.5,
            ...
            Text(
              ...
              style: TextStyle( fontFamily: getTranslated(context, 'fontFamily'),  fontSize: 10.0,
                color: AppColors.grey,
                fontWeight: FontWeight.normal,),
