  ...
  Widget build(BuildContext context) {
    return Align(
     ...
     /*   decoration: BoxDecoration(
        ...
        color: (widget.owner?AppColors.pink:AppColors.lightGrey),
      ),*/
        child:VoiceMessage(
          meBgColor:(widget.owner ? AppColors.pink:AppColors.lightGrey ),
          mePlayIconColor:Colors.white,
          meFgColor:Colors.white,
          contactBgColor: (widget.owner ? AppColors.pink:AppColors.lightGrey ),
          contactPlayIconColor:  Colors.white,
          contactFgColor:  widget.owner ? AppColors.black.withOpacity(0.5):Colors.black.withOpacity(0.5),
          audioSrc: widget.url,
...
class PlayRecordWidget extends  StatefulWidget {
  ...
  const PlayRecordWidget({Key? key, required this.url}) : super(key: key);
  @override
  State<PlayRecordWidget> createState() => _PlayRecordWidgetState();
}
