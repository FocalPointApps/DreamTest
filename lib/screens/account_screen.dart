...
class _AccountScreenState extends State<AccountScreen> {
  ...
  save() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      widget.user.fromUtc2=DateTime(datenow.year, datenow.month, datenow.day,int.parse(fromtime), 0, 0).toUtc().toString();
      widget.user.toUtc2=DateTime(datenow.year, datenow.month, datenow.day,int.parse(totime), 0, 0).toUtc().toString();
      setState(() {
        dataSave=true;
      });
