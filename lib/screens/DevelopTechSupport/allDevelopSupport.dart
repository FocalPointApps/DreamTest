                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(height: 40,width: size.width*.20,
                          ...
                          decoration: BoxDecoration(
                            color: _new?Theme.of(context).primaryColor:Colors.white,
                            ...
                            child: Text(
                              ...
                              style: TextStyle( fontFamily: getTranslated(context, 'fontFamily'),
                                color: _new?Colors.white:Theme.of(context).primaryColor,
                                fontSize: 15.0,
                      ...
                      InkWell(
                        ...
                        child: Container(height: 40,width: size.width*.20,
                          padding: const EdgeInsets.all(5),
                          decoration: BoxDecoration(
                            color: _open?Theme.of(context).primaryColor:Colors.white,
                            borderRadius: BorderRadius.circular(20.0),
                          ),child:Center(
                            child: Text(
                              "Open",
                              textAlign: TextAlign.center,
                              style: TextStyle( fontFamily: getTranslated(context, 'fontFamily'),
                                color: _open?Colors.white:Theme.of(context).primaryColor,
                                fontSize: 15.0,
                                fontWeight: FontWeight.bold,
                                letterSpacing: 0.3,
                              ),
                      ...
                      InkWell(
                        ...
                        child: Container(height: 40,width: size.width*.20,
                          padding: const EdgeInsets.all(5),
                          decoration: BoxDecoration(
                            color: _done?Theme.of(context).primaryColor:Colors.white,
                            borderRadius: BorderRadius.circular(20.0),
                          ),child:Center(
                            child: Text(
                            "Done",
                              textAlign: TextAlign.center,
                              style: TextStyle( fontFamily: getTranslated(context, 'fontFamily'),
                                color: _done?Colors.white:Theme.of(context).primaryColor,
                                fontSize: 15.0,
                                fontWeight: FontWeight.bold,
                                letterSpacing: 0.3,
                              ),
                      ...
                      InkWell(
                        ...
                        child: Container(height: 40,width: size.width*.20,
                          padding: const EdgeInsets.all(5),
                          decoration: BoxDecoration(
                            color: _closed?Theme.of(context).primaryColor:Colors.white,
                            borderRadius: BorderRadius.circular(20.0),
                          ),child:Center(
                            child: Text(
                             "Closed",
                              textAlign: TextAlign.center,
                              style: TextStyle( fontFamily: getTranslated(context, 'fontFamily'),
                                color: _closed?Colors.white:Theme.of(context).primaryColor,
                                fontSize: 15.0,
                                fontWeight: FontWeight.bold,
                                letterSpacing: 0.3,
                              ),
