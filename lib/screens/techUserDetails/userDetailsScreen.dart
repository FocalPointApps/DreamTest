...
class _UserDetailsScreenState extends State<UserDetailsScreen> {
  ...
  bool first=true,saving=false,load=false,activeValue=false,activeUser=false,accept=false;
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(physics:  AlwaysScrollableScrollPhysics(),children: [
                                            ...
                                            child: Container(height: 50,width: size.width,
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  Container(width: size.width*.25,
                                                    child: Text(
                                                      packages[index].callNum.toString()+  packages[index].type,
                                                      style: TextStyle( fontFamily: getTranslated(context, 'fontFamily'),
                                                        color: theme=="light"?Theme.of(context).primaryColor:Colors.black,
                                                        fontSize: 15.0,
                                                        fontWeight: FontWeight.bold,
                  ...
                  widget.user.userType=="USER"?SizedBox():Row(
                    children: [
                      Checkbox(
                        value: accept,
                        onChanged: (value) {
                  ...
                  SizedBox(width: 10,),
                  widget.user.userType=="USER"?SizedBox():saving ? CircularProgressIndicator() :
                  Container(
                    width: 50.0,
                    child: MaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        await FirebaseFirestore.instance.collection(
                            Paths.usersPath).doc(widget.user.uid).update({
                              "userType": "USER"
                            });
                        setState(() {
                          saving = false;
