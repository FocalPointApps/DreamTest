...
class OrderDetails extends StatefulWidget {
  ...
  const OrderDetails({Key? key, required this.order, this.type, this.fromSupport})
      : super(key: key);
  @override
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      widget.order.consultType=="chat"?getTranslated(context,  "chat"):getTranslated(context,  "voice"),
                                      style: TextStyle(
                                        color: AppColors.pink,
                                        fontSize: 15.0,
                                      ),
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      (package==null||package!.callNum==null)?"0":package!.callNum.toString(),
                                      style: TextStyle(
                                ...
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      (package==null||package!.discount==null)?"0%": package!.discount.toString()+ "%",
                                      style: TextStyle(
                                        color: theme == "light"? AppColors.pink : AppColors.white,
                                        fontSize: 15.0,
                                      ),
                                ...
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      (package==null||package!.price==null)?"0":package!.price.toString()+ "\$",
                                      style: TextStyle(
                                        color: theme == "light"? AppColors.pink : AppColors.white,
                                        fontSize: 15.0,
                                      ),
